...
?>
    ...
    <script src="<?php echo site_url(); ?>/wp-content/themes/Divi Child/owl/jquery.min.js"></script>
...
?>
	...
	<div class="top-header33"> 
		<ul>
			...
			<li><a href="<?php echo site_url(); ?>/my-account/">Welcome <?=$current_user->nickname?>!</a></li>
			<li><a href="<?php echo wp_logout_url( home_url() ); ?>">Logout</a></li>
			<?php }else{ ?>
			<li class="green"><a href="<?php echo site_url(); ?>/sign-up/"> Sign Up</a></li>
			<li class="green"><a href="<?php echo site_url(); ?>/sign-in/"><img alt="" src="<?php echo site_url(); ?>/wp-content/uploads/2019/06/lock.png"> Sign In</a></li>
			<?php } ?>
