...
ToxProgressBar.prototype.create = function () {
    ...
    this.element.innerHTML =
        ...
        '   <div class="radial-inner" style="background-color: #ffffff ; width: ' + (this.size - (this.thickness * 2)) + 'px; height: ' + (this.size - (this.thickness * 2) + 2) + 'px; top: -' + ((this.size) * 2.5 - this.thickness + 6) + 'px; left: ' + this.thickness + 'px"></div>' +
        '</div>' +
        (content ? (
